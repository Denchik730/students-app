...
class EditPersonTests: TestCase(kaspressoBuilder) {
    ...
    fun successEditPersonTest() = run {
        ...
        with(mainScreen) {
            step("Добавить несколько пользователей") {
        ...
        step("Проверить что открывается главный экран, на котором у выбранного пользователя изменилось имя на “Иосиф”") {
            mainScreen.checkNameSelectedCatInList(0, "Иосиф")
        }
    }
}